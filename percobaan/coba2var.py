...
slider_risiko.pack(pady=10)
slider_pengembalian.pack(pady=10)
btn_hitung = tk.Button(frame_input, text="Hitung", command=hitung_rekomendasi, bg="#4caf50", fg="white", font=("Helvetica", 14))
btn_hitung.pack(pady=20)

frame_result = tk.Frame(root, bg="#e3f2fd")
result_risiko = tk.Label(frame_result, bg="#e3f2fd", font=("Helvetica", 12))
result_pengembalian = tk.Label(frame_result, bg="#e3f2fd", font=("Helvetica", 12))
result_output = tk.Label(frame_result, bg="#e3f2fd", font=("Helvetica", 14, "bold"))
result_risiko.pack(pady=5)
result_pengembalian.pack(pady=5)
result_output.pack(pady=20)

btn_show_graph = tk.Button(root, text="Tampilkan Grafik", command=show_graph, bg="#ff9800", fg="white", font=("Helvetica", 14))
btn_back = tk.Button(root, text="Kembali", command=lambda: show_slide(0), bg="#1e88e5", fg="white", font=("Helvetica", 14))
