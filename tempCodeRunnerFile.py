...
if hasil_sim.output['keputusan_investasi'] > 5: 
    result.set(f"Hasil: {hasil_sim.output['keputusan_investasi']:.2f} (Highly Recommended)") #ini buat nampilin hasilnya
elif hasil_sim.output['keputusan_investasi'] > 3:
    ...
    messagebox.showinfo("Hasil", f"Hasil: {hasil_sim.output['keputusan_investasi']:.2f}") #ini buat nampilin hasilnya di message box        
